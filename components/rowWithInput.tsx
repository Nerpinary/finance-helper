...
const RowWithCheckboxInput = ({id, value, valuteValue, onChange, onChangeSelect, text, type, placeholder}) => (
        <Container
            w="full"
            flexWrap="wrap"
            alignItems="center"
        ...
        >
            ...
            >
                ...
                <Select onChange={onChangeSelect} bg={useColorModeValue('#f3f9f699', '#f3f9f622')} value={valuteValue} variant="outline" mt={2} w="40%">
